-injars 'C:\DATI\workspace\WSTM\weshowthemoney.jar'
-outjars 'C:\DATI\workspace\WSTM\weshowthemoneyMINI.jar'

-libraryjars 'C:\Programmi\Java\jre1.5.0_09\lib\rt.jar'
...
-keep public class com.weshowthemoney.** {
    public <methods>;
}

-keep,allowshrinking public class com.weshowthemoney.** {
    public protected <fields>;
    public protected <methods>;
    
}

-keep,allowshrinking public class prefuse.controls.** {
    public protected <fields>;
    public protected <methods>;
    
}

-keep,allowshrinking public final interface  **ExportDisplayAction** {
    public private protected static final synchronized native abstract strictfp <methods>;
}
